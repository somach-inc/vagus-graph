...
"Under that is the causal loop: iPhone Shortcut writes to Butterbase, the Mac
agent polls the row, RocketRide classifies energy with a GPT-5.5 policy, Neo4j
checks task blockers, and the menu bar plus dashboard react."
